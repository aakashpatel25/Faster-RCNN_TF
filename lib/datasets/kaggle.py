...
class kaggle(datasets.imdb):
	def __init__(self, image_set, kaggle_path=None):
		datasets.imdb.__init__(self, 'kaggle_' + image_set)
		self._image_set = image_set
		self._devkit_path = self._get_default_path() if kaggle_path is None else kaggle_path
		self._data_path = os.path.join(self._devkit_path, 'KaggleFish')
		self._classes = ('__background__', 'ALB', 'BET', 'DOL', 'LAG', 'SHARK', 'YFT','OTHER')
		...
		assert os.path.exists(self._devkit_path), 'KaggleFish path does not exist: {}'.format(self._devkit_path)
	...
	def _get_default_path(self):
		...
		"""
		return os.path.join(cfg.DATA_DIR, 'KaggleFish')
